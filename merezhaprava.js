document.addEventListener("DOMContentLoaded", function () {
  ...
  if (window.location.pathname === "/contact") {
    ...
    window.initMap = function() {
      const cities = {
        Київ: {
          address: "м. Київ, вул. Лаврська, 16",
          lat: 50.432511,
          lng: 30.555173,
        },
        Одеса: {
          address: "м. Одеса, вул. Базарна, 60",
          lat: 46.474095,
          lng: 30.742081,
        },
        Вінниця: {
          address: "м. Вінниця, вул. Магістратська, 5",
          lat: 49.235749,
          lng: 28.47464,
        },
        Львів: {
        ...
        Житомир: {
          address: "м. Житомир, майдан Перемоги, 4/2",
          lat: 50.256827,
          lng: 28.659659,
        },
        Дніпро: {
          address: "м. Дніпро, вул. Барикадна, 20",
          lat: 48.462859,
          lng: 35.055371,
        },
        Рівне: {
          address: "м. Рівне, вул. Міцкевича, 3",
          lat: 50.623744,
          lng: 26.255705,
        },
        Верховина: {
          address:
            "с. Верховина, Івано-Франківська область, вул. Жаб'євська, 10Б",
          lat: 48.155611,
          lng: 24.826549,
        },
        Полтава: {
          address: "м. Полтава, вул. Соборності, 46",
          lat: 49.593049,
          lng: 34.544638,
        },
      };
      ...
      for (const city in cities) {
        ...
        const marker = new google.maps.Marker({
          ...
          icon: {
            url: "https://cdn.jsdelivr.net/gh/topbs/merezha-prava@main/logo.png",
